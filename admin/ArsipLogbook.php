                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="ArsipLogbook-export.php">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn btn-primary" name="exportLogbook" value="Export Excel">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered d-flex align-items-center justify-content-center">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="ArsipLogbook.php">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                            <button type="submit" class="btn btn-primary" name="filterLogbook">Filter</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
