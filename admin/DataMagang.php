                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="DataMagang-export.php">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn btn-primary" name="exportDataMagang" value="Export Excel">
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="DataMagang.php">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="tambahMahasiswa">Create</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
